...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $hoanghoa = new Product($maHangHoa,$tenHangHoa, $donViTinh, $donGia,$hinh);
    $product_db->suahanghoa($hoanghoa);
    header("Location: ../Views/Admin/quanlyhanghoa.php?msg2=update");
}